...
public aspect Parents {
    ...
    declare parents: @Implementation CoreNSAwareAttribute+ implements DOMNSAwareTypedAttribute;
    declare parents: @Implementation CoreNSUnawareAttribute+ implements DOMNSUnawareTypedAttribute;
