...
public class ElementNamespaceFilterIterator extends FilterIterator<Element> {
    private final String namespaceURI;

    public ElementNamespaceFilterIterator(Iterator<Element> parent, String namespaceURI) {
        super(parent);
