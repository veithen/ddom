...
class ModelExtensionGenerator {
    ...
    void addModelExtensionInterface(ModelExtensionInterfaceInfo modelExtensionInterface) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Added model extension interface " + modelExtensionInterface.getClassInfo() + " (abstract=" + modelExtensionInterface.isAbstract()
                    + "; parent=" + modelExtensionInterface.getParent() + "; root=" + modelExtensionInterface.getRoot() + ")");
        }
    }
