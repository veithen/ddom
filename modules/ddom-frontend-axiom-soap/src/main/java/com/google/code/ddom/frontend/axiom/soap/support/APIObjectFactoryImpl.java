...
public class APIObjectFactoryImpl implements APIObjectFactory {
    ...
    public APIObjectFactoryImpl(AxiomSOAPNodeFactory nodeFactory) {
    ...
    public Object getAPIObject(Class<?> clazz) {
        ...
        } else if (clazz.equals(AxiomSOAPFactories.class)) {
            return new AxiomSOAPFactoriesImpl(nodeFactory);
        } else {
            return null;
        }
    }
