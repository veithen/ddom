...
*/
public final class nodecomparedocumentposition11 extends DOMTestCase {
    ...
    */
   public nodecomparedocumentposition11(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      attrPosition = (int) newAttr.compareDocumentPosition(doc);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(nodecomparedocumentposition11.class, args);
   }
}
