...
*/
public final class hasFeature02 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public hasFeature02(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
assertTrue("hasCore30", state);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(hasFeature02.class, args);
   }
}
