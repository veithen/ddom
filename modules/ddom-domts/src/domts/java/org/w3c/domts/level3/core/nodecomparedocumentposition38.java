...
*/
public final class nodecomparedocumentposition38 extends DOMTestCase {
    ...
    */
   public nodecomparedocumentposition38(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      attrPosition = (int) attr.compareDocumentPosition(txt);
      assertEquals("nodecomparedocumentpositionIsContainsFollowing38", 20, attrPosition);
      attrChildPosition = (int) txt.compareDocumentPosition(attr);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(nodecomparedocumentposition38.class, args);
   }
}
