...
*/
public final class nodegetbaseuri02 extends DOMTestCase {
    ...
    */
   public nodegetbaseuri02(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      baseURI = newDoc.getBaseURI();
      assertEqualsIgnoreCase("baseURISameAsDocURI", "http://www.example.com/sample.xml", baseURI);
}
   /**
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(nodegetbaseuri02.class, args);
   }
}
