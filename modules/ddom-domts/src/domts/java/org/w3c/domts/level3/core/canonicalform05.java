...
*/
public final class canonicalform05 extends DOMTestCase {
    ...
    */
   public canonicalform05(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
...
for (int indexN100C4 = 0; indexN100C4 < errors.size(); indexN100C4++) {
          error = (DOMError) errors.get(indexN100C4);
...
lineNumber = (int) location.getLineNumber();
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(canonicalform05.class, args);
   }
}
