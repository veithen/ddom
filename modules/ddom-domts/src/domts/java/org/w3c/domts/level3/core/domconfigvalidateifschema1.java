...
*/
public final class domconfigvalidateifschema1 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domconfigvalidateifschema1(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      boolean canSet;
      boolean state;
      String parameter = "vAlIdate-if-schema";
...
state = ((Boolean) domConfig.getParameter(parameter)).booleanValue();
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domconfigvalidateifschema1.class, args);
   }
}
