...
public class TestCoreSetSourceNSAwareWithNamespaceURIMismatch extends BackendTestCase {
    public TestCoreSetSourceNSAwareWithNamespaceURIMismatch(BackendTestSuiteConfig config) {
        super(config);
    }
