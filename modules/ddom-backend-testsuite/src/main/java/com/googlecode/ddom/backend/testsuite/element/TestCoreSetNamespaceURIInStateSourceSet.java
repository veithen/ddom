...
public class TestCoreSetNamespaceURIInStateSourceSet extends BackendTestCase {
    public TestCoreSetNamespaceURIInStateSourceSet(BackendTestSuiteConfig config) {
        super(config);
    }
