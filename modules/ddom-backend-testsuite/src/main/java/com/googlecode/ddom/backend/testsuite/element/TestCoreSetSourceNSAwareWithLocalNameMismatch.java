...
public class TestCoreSetSourceNSAwareWithLocalNameMismatch extends BackendTestCase {
    public TestCoreSetSourceNSAwareWithLocalNameMismatch(BackendTestSuiteConfig config) {
        super(config);
    }
    ...
    protected void runTest() throws Throwable {
        ...
        element.coreSetSource(toXmlSource("<p:other xmlns:p='urn:ns'>text</p:other>", true, true));
        try {
