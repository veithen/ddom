...
/**
 * Tests that {@link CoreElement#coreGetFirstAttribute()} causes expansion of the element when it is
 * in state "Content set".
 * 
 * @author Andreas Veithen
 */
public class TestCoreGetFirstAttributeInStateSourceSet extends BackendTestCase {
    public TestCoreGetFirstAttributeInStateSourceSet(BackendTestSuiteConfig config) {
        super(config);
    }
