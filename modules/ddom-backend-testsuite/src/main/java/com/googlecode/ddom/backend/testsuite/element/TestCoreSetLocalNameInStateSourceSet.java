...
public class TestCoreSetLocalNameInStateSourceSet extends BackendTestCase {
    public TestCoreSetLocalNameInStateSourceSet(BackendTestSuiteConfig config) {
        super(config);
    }
