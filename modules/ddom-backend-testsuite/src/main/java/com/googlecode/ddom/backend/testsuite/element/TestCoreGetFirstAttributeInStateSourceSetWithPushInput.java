...
public class TestCoreGetFirstAttributeInStateSourceSetWithPushInput extends BackendTestCase {
    public TestCoreGetFirstAttributeInStateSourceSetWithPushInput(BackendTestSuiteConfig config) {
        super(config);
    }
