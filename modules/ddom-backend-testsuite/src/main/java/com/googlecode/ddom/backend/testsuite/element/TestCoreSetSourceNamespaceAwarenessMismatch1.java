...
public class TestCoreSetSourceNamespaceAwarenessMismatch1 extends BackendTestCase {
    public TestCoreSetSourceNamespaceAwarenessMismatch1(BackendTestSuiteConfig config) {
        super(config);
    }
