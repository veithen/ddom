...
public class TestCoreSetValueEmptyString extends ParentNodeTestCase {
    public TestCoreSetValueEmptyString(BackendTestSuiteConfig config, ParentNodeFactory parentNodeFactory) {
