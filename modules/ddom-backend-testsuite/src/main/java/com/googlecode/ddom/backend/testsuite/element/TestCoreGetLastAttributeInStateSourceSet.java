...
/**
 * Tests that {@link CoreElement#coreGetLastAttribute()} causes expansion of the element when it is
 * in state "Content set".
 * 
 * @author Andreas Veithen
 */
public class TestCoreGetLastAttributeInStateSourceSet extends BackendTestCase {
    public TestCoreGetLastAttributeInStateSourceSet(BackendTestSuiteConfig config) {
        super(config);
    }
    ...
    protected void runTest() throws Throwable {
        ...
        CoreAttribute attr = element.coreGetLastAttribute();
        assertNotNull(attr);
