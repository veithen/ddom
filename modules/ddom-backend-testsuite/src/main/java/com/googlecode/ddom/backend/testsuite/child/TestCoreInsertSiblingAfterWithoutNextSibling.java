...
public class TestCoreInsertSiblingAfterWithoutNextSibling extends BackendTestCase {
    public TestCoreInsertSiblingAfterWithoutNextSibling(BackendTestSuiteConfig config) {
        super(config);
    }
