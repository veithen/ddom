...
/**
 * Tests that {@link CoreParentNode#coreGetFirstChild()} throws a {@link NodeConsumedException} on a fully consumed
 * {@link CoreElement}.
 * 
 * @author Andreas Veithen
 */
public class TestCoreGetFirstChildInStateConsumedFull extends BackendTestCase {
    public TestCoreGetFirstChildInStateConsumedFull(BackendTestSuiteConfig config) {
        super(config);
    }
