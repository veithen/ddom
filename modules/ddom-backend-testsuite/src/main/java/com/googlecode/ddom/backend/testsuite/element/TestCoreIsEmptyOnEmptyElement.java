...
public class TestCoreIsEmptyOnEmptyElement extends BackendTestCase {
    public TestCoreIsEmptyOnEmptyElement(BackendTestSuiteConfig config) {
        super(config);
    }
    ...
    protected void runTest() throws Throwable {
        ...
        assertTrue(element.coreIsEmpty());
    }
}
