...
*/
public final class domconfigcdatasections1 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domconfigcdatasections1(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      boolean canSet;
      boolean state;
      String parameter = "cDaTa-sections";
...
domConfig.setParameter(parameter, Boolean.TRUE);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domconfigcdatasections1.class, args);
   }
}
