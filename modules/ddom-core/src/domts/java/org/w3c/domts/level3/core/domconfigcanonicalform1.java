...
*/
public final class domconfigcanonicalform1 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domconfigcanonicalform1(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      boolean canSet;
      boolean state;
      String parameter = "cAnOnical-form";
...
state = ((Boolean) domConfig.getParameter(parameter)).booleanValue();
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domconfigcanonicalform1.class, args);
   }
}
