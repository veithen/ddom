...
*/
public final class nodegetfeature12 extends DOMTestCase {
    ...
    */
   public nodegetfeature12(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
...
isSupported = node.isSupported("XML", nullVersion);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(nodegetfeature12.class, args);
   }
}
