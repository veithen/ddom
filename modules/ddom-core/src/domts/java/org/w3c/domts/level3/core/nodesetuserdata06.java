...
*/
public final class nodesetuserdata06 extends DOMTestCase {
    ...
    */
   public nodesetuserdata06(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      entity = (Entity) entities.getNamedItem("delta");
      comment = doc.createComment("COMMENT_NODE");
      retUserData = comment.setUserData("Key1", ((Object) /*Node */entity), nullHandler);
      returned = comment.setUserData("Key1", ((Object) /*Node */entity), nullHandler);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(nodesetuserdata06.class, args);
   }
}
