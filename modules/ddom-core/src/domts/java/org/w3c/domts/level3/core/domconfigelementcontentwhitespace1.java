...
*/
public final class domconfigelementcontentwhitespace1 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domconfigelementcontentwhitespace1(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      boolean canSet;
      boolean state;
      String parameter = "eLeMent-content-whitespace";
...
state = ((Boolean) domConfig.getParameter(parameter)).booleanValue();
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domconfigelementcontentwhitespace1.class, args);
   }
}
