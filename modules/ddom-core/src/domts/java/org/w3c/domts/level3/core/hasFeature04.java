...
*/
public final class hasFeature04 extends DOMTestCase {
    ...
    */
   public hasFeature04(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
...
assertTrue("hasXML30", state);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(hasFeature04.class, args);
   }
}
