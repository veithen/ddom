...
*/
public final class domimplementationregistry05 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domimplementationregistry05(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
assertTrue("hasCore", hasFeature);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domimplementationregistry05.class, args);
   }
}
