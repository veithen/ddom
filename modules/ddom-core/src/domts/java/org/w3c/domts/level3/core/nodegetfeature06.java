...
*/
public final class nodegetfeature06 extends DOMTestCase {
    ...
    */
   public nodegetfeature06(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
...
isSupported = node.isSupported("XML", nullVersion);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(nodegetfeature06.class, args);
   }
}
