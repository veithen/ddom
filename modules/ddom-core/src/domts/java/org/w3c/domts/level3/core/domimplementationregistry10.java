...
*/
public final class domimplementationregistry10 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domimplementationregistry10(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
assertTrue("hasCore", hasFeature);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domimplementationregistry10.class, args);
   }
}
