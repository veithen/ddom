...
*/
public final class nodegetfeature10 extends DOMTestCase {
    ...
    */
   public nodegetfeature10(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
...
isSupported = node.isSupported("XML", nullVersion);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(nodegetfeature10.class, args);
   }
}
