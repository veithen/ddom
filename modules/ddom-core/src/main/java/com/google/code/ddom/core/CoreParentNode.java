...
public interface CoreParentNode extends CoreNode {
     ...
     * instance.
     * <li>If one of the descendants of this node is unexpanded and has a {@link FragmentSource}
     ...
     * request an {@link XmlInput} instance from the {@link FragmentSource} and pass through events
     * generated by that instance. This occurs even if <code>preserve</code> is set to
     * <code>true</code>. Indeed, since the {@link FragmentSource} is non destructive, it is still
     * possible to expand the node afterwards. On the other hand, if the {@link FragmentSource} is
