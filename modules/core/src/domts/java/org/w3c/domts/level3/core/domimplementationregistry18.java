...
*/
public final class domimplementationregistry18 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domimplementationregistry18(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domimplementationregistry18.class, args);
   }
}
