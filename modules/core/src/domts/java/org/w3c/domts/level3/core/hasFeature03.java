...
*/
public final class hasFeature03 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public hasFeature03(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
assertTrue("hasPlusCore30", state);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(hasFeature03.class, args);
   }
}
