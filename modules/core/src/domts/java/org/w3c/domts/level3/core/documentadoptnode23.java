...
*/
public final class documentadoptnode23 extends DOMTestCase {
    ...
    */
   public documentadoptnode23(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      acronymElemLen = (int) acronymElemChild.getLength();
      adoptedNodeChild = adoptedNode.getChildNodes();
      adoptedLen = (int) adoptedNodeChild.getLength();
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(documentadoptnode23.class, args);
   }
}
