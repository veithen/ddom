...
*/
public final class documentgetxmlencoding05 extends DOMTestCase {
    ...
    */
   public documentgetxmlencoding05(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
   ...
   public void runTest() throws Throwable {
    ...
    (equals("uTf-8", encodingName) | (encodingName == null))
);
      }
   /**
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(documentgetxmlencoding05.class, args);
   }
}
