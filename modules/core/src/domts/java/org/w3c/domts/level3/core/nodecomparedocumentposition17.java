...
*/
public final class nodecomparedocumentposition17 extends DOMTestCase {
    ...
    */
   public nodecomparedocumentposition17(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      pi1Position = (int) pi1.compareDocumentPosition(pi2);
      assertEquals("nodecomparedocumentpositionFollowing17", 4, pi1Position);
      pi2Position = (int) pi2.compareDocumentPosition(pi1);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(nodecomparedocumentposition17.class, args);
   }
}
