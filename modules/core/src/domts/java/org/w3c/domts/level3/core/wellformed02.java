...
*/
public final class wellformed02 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public wellformed02(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
assertSize("noError", 0, errors);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(wellformed02.class, args);
   }
}
