...
*/
public final class documentgetxmlversion02 extends DOMTestCase {
    ...
    */
   public documentgetxmlversion02(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      assertEqualsIgnoreCase("documentgetxmlversion02", "1.0", versionValue);
}
   /**
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(documentgetxmlversion02.class, args);
   }
}
