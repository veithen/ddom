...
*/
public final class domimplementationregistry08 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domimplementationregistry08(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
assertTrue("hasCore", hasFeature);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domimplementationregistry08.class, args);
   }
}
