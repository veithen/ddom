...
*/
public final class domconfignormalizecharacters1 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domconfignormalizecharacters1(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
state = ((Boolean) domConfig.getParameter(parameter)).booleanValue();
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domconfignormalizecharacters1.class, args);
   }
}
