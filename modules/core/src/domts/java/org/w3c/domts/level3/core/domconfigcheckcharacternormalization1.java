...
*/
public final class domconfigcheckcharacternormalization1 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domconfigcheckcharacternormalization1(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
   ...
   public void runTest() throws Throwable {
      ...
      boolean canSet;
      boolean state;
      String parameter = "cHeCk-character-normalization";
...
state = ((Boolean) domConfig.getParameter(parameter)).booleanValue();
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domconfigcheckcharacternormalization1.class, args);
   }
}
