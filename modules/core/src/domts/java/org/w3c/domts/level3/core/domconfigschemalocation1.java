...
public final class domconfigschemalocation1 extends DOMTestCase {
    ...
    */
   public domconfigschemalocation1(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
canSet = domConfig.canSetParameter(parameter, ((Object) /*DOMString */sampleSchemaLocation));
      assertTrue("canSetURI", canSet);
      canSet = domConfig.canSetParameter(parameter, ((Object) /*DOMString */nullSchemaLocation));
      assertTrue("canSetNull", canSet);
      domConfig.setParameter(parameter, ((Object) /*DOMString */sampleSchemaLocation));
      state = (String) domConfig.getParameter(parameter);
      assertEquals("setURIEffective", sampleSchemaLocation, state);
      domConfig.setParameter(parameter, ((Object) /*DOMString */nullSchemaLocation));
      state = (String) domConfig.getParameter(parameter);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domconfigschemalocation1.class, args);
   }
}
