...
*/
public final class hasFeature01 extends DOMTestCase {
    ...
    */
   public hasFeature01(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
...
assertTrue("hasXML30", state);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(hasFeature01.class, args);
   }
}
