...
*/
public final class domimplementationregistry07 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domimplementationregistry07(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domimplementationregistry07.class, args);
   }
}
