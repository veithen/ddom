...
*/
public final class domimplementationregistry03 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domimplementationregistry03(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
assertTrue("hasCore", hasFeature);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domimplementationregistry03.class, args);
   }
}
