...
*/
public final class userdatahandler02 extends DOMTestCase {
    ...
    */
   public userdatahandler02(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
...
assertSize("twoNotifications", 2, notifications);
      for (int indexN1009C = 0; indexN1009C < notifications.size(); indexN1009C++) {
          notification = (org.w3c.domts.UserDataNotification) notifications.get(indexN1009C);
...
assertSame("dstIsNewNode", newNode, dst);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(userdatahandler02.class, args);
   }
}
