...
import com.google.code.ddom.frontend.saaj.ext.SOAP12HeaderElementExtension;
...
@Mixin(SOAP12HeaderElementExtension.class)
public abstract class SOAP12HeaderElementSupport implements SAAJSOAPHeaderElement {
