...
import com.googlecode.ddom.frontend.dom.DOMFrontend;
...
public class SAAJFrontend extends DOMFrontend {
    ...
    public ClassCollection getMixins(Map<String,Frontend> frontends) {
        ...
        aggregate.add(Module.forClass(SAAJFrontend.class).getPackage("com.googlecode.ddom.frontend.saaj.mixin"));
        return aggregate;
    }

    public Class<? extends ModelExtension> getModelExtension() {
        return SAAJModelExtension.class;
    }
}
