...
public final class HeaderElementMatcher implements ElementMatcher<SAAJSOAPHeaderElement> {
    public static final HeaderElementMatcher INSTANCE = new HeaderElementMatcher();
    
    private HeaderElementMatcher() {}

    public boolean matches(SAAJSOAPHeaderElement element, String namespaceURI, String name) {
        return name.equals(element.getActor());
    }
}
