...
public class ElementsIterator<T extends CoreElement> extends AbstractNodeIterator<T> {
    ...
    public ElementsIterator(CoreParentNode startNode, Axis axis, Class<T> type, ElementMatcher<? super T> matcher, String namespaceURI, String name, ExceptionTranslator exceptionTranslator) {
        super(startNode, axis, type, exceptionTranslator);
