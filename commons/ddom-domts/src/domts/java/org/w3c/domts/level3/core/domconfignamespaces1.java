...
*/
public final class domconfignamespaces1 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domconfignamespaces1(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
state = ((Boolean) domConfig.getParameter(parameter)).booleanValue();
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domconfignamespaces1.class, args);
   }
}
