...
*/
public final class domconfiginfoset1 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domconfiginfoset1(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
domConfig.setParameter(parameter, Boolean.FALSE);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domconfiginfoset1.class, args);
   }
}
