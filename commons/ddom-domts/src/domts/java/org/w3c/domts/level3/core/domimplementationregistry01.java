...
*/
public final class domimplementationregistry01 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domimplementationregistry01(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domimplementationregistry01.class, args);
   }
}
