...
*/
public final class nodegetfeature13 extends DOMTestCase {
    ...
    */
   public nodegetfeature13(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
...
isSupported = node.isSupported("XML", nullVersion);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(nodegetfeature13.class, args);
   }
}
