...
*/
public final class domconfigwellformed1 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domconfigwellformed1(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
state = ((Boolean) domConfig.getParameter(parameter)).booleanValue();
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domconfigwellformed1.class, args);
   }
}
