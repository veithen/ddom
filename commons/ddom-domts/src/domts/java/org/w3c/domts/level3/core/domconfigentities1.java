...
*/
public final class domconfigentities1 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domconfigentities1(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
domConfig.setParameter(parameter, Boolean.TRUE);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domconfigentities1.class, args);
   }
}
