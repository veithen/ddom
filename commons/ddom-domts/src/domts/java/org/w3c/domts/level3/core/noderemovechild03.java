...
*/
public final class noderemovechild03 extends DOMTestCase {
    ...
    */
   public noderemovechild03(final DOMTestDocumentBuilderFactory factory)  throws org.w3c.domts.DOMTestIncompatibleException {
      super(factory);
   ...
   public void runTest() throws Throwable {
      Document doc;
      Element docElem;
      Element removedChild;
      Node removed;
      doc = (Document) load("hc_staff", true);
      docElem = doc.getDocumentElement();
      removed = doc.removeChild(docElem);
      removedChild = doc.getDocumentElement();
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(noderemovechild03.class, args);
   }
}
