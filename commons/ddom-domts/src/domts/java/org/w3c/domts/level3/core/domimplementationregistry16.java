...
*/
public final class domimplementationregistry16 extends DOMTestCase {

   /**
    * Constructor.
    * @param factory document factory, may not be null
    */
   public domimplementationregistry16(final DOMTestDocumentBuilderFactory factory)  {
      super(factory);
...
assertTrue("hasCore", hasFeature);
   ...
   public static void main(final String[] args) {
        DOMTestCase.doMain(domimplementationregistry16.class, args);
   }
}
